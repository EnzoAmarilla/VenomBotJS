...
function configurarListenersDeVenom() {
  ...
  client.onMessage(async (message) => {
    ...
    // let textoMensaje = message.body.toLowerCase().trim();
    let textoMensaje = message.body.trim();
    console.log('📨 Mensaje recibido trim:', textoMensaje);
    ...
    axios.post('http://127.0.0.1:8000/api/webhook/whatsapp', {
      ...
      console.log("Mensaje no enviado a backend");
    });
